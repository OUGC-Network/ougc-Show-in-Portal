...
$l = [
    ...
    'setting_ougc_showinportal_allowedGroups_desc' => 'Select the groups allowed to use this feature.',
    'setting_ougc_showinportal_enabledForums' => 'Enabled Forums',
    'setting_ougc_showinportal_enabledForums_desc' => 'Select the forums where this feature should be enabled in.',
    'setting_ougc_showinportal_enableReadMore' => 'Enable Read More Tag',
    'setting_ougc_showinportal_enableReadMore_desc' => 'Enable users using a tag to cut portal messages.',
    'setting_ougc_showinportal_readMoreTag' => 'Read More Tag String',
    'setting_ougc_showinportal_readMoreTag_desc' => 'Insert the string used to build the read more feature. Default: <code>[!--more--]</code>',
    'setting_ougc_showinportal_notifyByPM' => 'Send PM Notification',
    'setting_ougc_showinportal_notifyByPM_desc' => 'Send a PM to authors when moderators add or remove their threads from the portal.',
    'setting_ougc_showinportal_notifyByAlert' => 'Send MyAlerts Notification',
    'setting_ougc_showinportal_notifyByAlert_desc' => 'Send an alert to authors when moderators add or remove their threads from the portal.',
